...
import nbtool.gui.logviews.images.BlackImageView;
...
public class NBConstants {
	...
	private static Map<String, Class<? extends ViewParent>[]> setupPossible() {
		...
		map.put("YUVImage", new Class[]{ImageView.class, ZoomImageView.class, FrontEndView.class, LineView.class, BallView.class, DebugImageView.class, BlackImageView.class});
